...
public class UnityUI : MonoBehaviour
{
	...
	//					추가적으로 사각형의 크기를 지정하기 위한 폭, 높이, UI의 구성인 앵커, 피벗이 있음 (-> 추가 기능이 더 많음)
	// 앵커(Anchor) : 자식컴포넌트의 부모 상대위치의 설정 "기준" 적용 -> 4갈래 꽃모양
	// 피벗(Pivot) : 위치, 회전, 크기의 "중심" 위치 -> 정가운데 동그라미 모양 
